...
public class MessageViewer extends Activity {
	...
	public static final String MESSAGE_ID_EXTRA = C.PACKAGE_NAME
			+ ".message_id";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		addressTextView.setText(getString(R.string.from) + ": "
				+ message.address);
		receivedAtTextView.setText(getString(R.string.received)
				+ ": "
				+ TimeFormatter.f(this, message.receivedAt,
						TimeFormatter.FULL_FORMAT));
